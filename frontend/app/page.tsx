...
export default function Home() {
  ...
  // ✅ Position utilisateur (longitude, latitude)
  ...
  return (
    <main className="w-screen h-screen relative bg-neutral-100">
      ...
      <button
        ...
        className="absolute bottom-5 right-5 z-30 bg-white border border-black/20 rounded-full px-4 py-2 shadow hover:bg-gray-100 text-sm"
      >
        📍 Me localiser
      </button>
